          ...
          <div className="grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 40 }}>
            ...
            >
              ...
              <p style={{ fontSize: 16, lineHeight: 1.7, color: 'var(--sys-gray)' }}>
                Transform the vehicle market of Sri Lanka by eliminating information gaps and delivering transparent, verifiable, data-driven intelligence that empowers buyers, sellers, and industry stakeholders to make confident, accurate, and forward-thinking decisions.
              </p>
            </motion.div>
